# -*- coding: utf-8 -*-
"""INVERSA_PYTHON.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1P3dclCXoS-siNz8pfN1tCFz9F_dneuYh
"""
...
"""COMPARACIÓN ENTRE LOS PROGRAMAS: 
 ...
 Python tiene muchas funciones incorporadas que permite hacer algoritmos extensos tan solo haciendo uso de ciertas librerias, por lo que es más práctico en ese sentido  y esto se puede apreciar en las extesión de la línea de 0 código.  

En cuanto a cada programa, cado uno de ellos muestra un mismo resultado por lo las respuestas en ambos son válidas pero es posible apreciar que varía la precisión de  los decimales que presentan (asociado a la capacidad de gastar memoria mientras se ejecuta el algoritmo).
